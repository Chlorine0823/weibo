...
#携带@的微博的百分比 存在第一人称的微博的百分比 积极（消极）微博的百分比  微博文本的平均长度
#微博当中褒义词和贬义词的数量 微博的情感得分的平均 携带积极（消极）表情的的微博的百分比 
#携带标签的微博的百分比 携带@的微博的百分比 携带问句标点的微博的百分比 携带感叹句标点的微博的百分比 携带多个问句/感叹句标点的百分比 
#提供个人描述的用户的百分比 提供个人图片的用户的百分比 验证的用户的百分比 验证的用户的类型的百分比 用户的互粉数量的平均值
#男性用户的百分比 来自大（小）城市的用户的百分比  用户粉丝数量的平均值 用户发微博数量的平均值 用户开通账户之后在线天数的平均值
#粉丝数/关注数的平均得分 微博转发数的平均值 微博评论数的平均值
