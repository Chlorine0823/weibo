...
DT = tree.DecisionTreeClassifier(min_weight_fraction_leaf = 0.12) 
SVM = SVC(C=1.2e-7, kernel='linear', max_iter=3000)
LR = sklearn.linear_model.LogisticRegression
LM = LR(penalty = 'l1', tol = 1.89)
